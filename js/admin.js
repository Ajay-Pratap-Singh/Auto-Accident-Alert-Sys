...
ambulances.on('child_added',snap=>{
    ...
    var marker= new google.maps.Marker({position:{lat:ambulance.permanentLocation.lat,lng:ambulance.permanentLocation.long},map,icon:'../img/ambulance.png'})
...
policeStations.on('child_added',snap=>{
    ...
    var marker= new google.maps.Marker({position:{lat:policeStation.location.lat,lng:policeStation.location.long},map,icon:'../img/police-station.png'});
